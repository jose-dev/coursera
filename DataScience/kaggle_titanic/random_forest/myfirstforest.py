...
csv_file_object = csv.reader(open('../ORIGINAL/train.csv', 'rb')) #Load in the training csv file
...
test_file_object = csv.reader(open('../ORIGINAL/test.csv', 'rb')) #Load in the test csv file
...
test_file_object = csv.reader(open('../ORIGINAL/test.csv', 'rb')) #Load in the csv file
